		...
		*/
		...
		editor.init = function () {
			...
			$.svgIcons(curConfig.imgPath + 'svg_edit_icons.svg', {
				...
				fallback: {
					'tool_fact': 'ellipse.png',
					'tool_ifact': 'freehand-circle.png',
...
//					$('.contextMenu').hide();
			...
			*/
			...
			var getReferences = function() {
				var currWikiPage = "http://localhost:8888/Leibniz/api.php?action=query&titles=BWBR0017869/2009-10-23/im1&format=jsonfm";
			}

			var saveNewReference = function() {
				var jurisCode = $('#jurisCode').val();
				console.log("Täääst: " + selectedElement.id);


				$(selectedElement.id).css("cursor", "crosshair");

				// selectedElement.setAttribute("onmouseover", "Täääst hehehe");
			...
			var cancelNewReference = function() {
				hideAddReference();
			}

			var hideAddReference = function() {
				$('#svg_reference').hide();
		...
		//	}
			...
			Actions = (function() {
				...
				var tool_buttons = [
					...
					{sel: '#tool_reference_save', fn: saveNewReference, evt: 'click'},
					{sel: '#tool_reference_cancel', fn: cancelNewReference, evt: 'click'},
					...
					{sel: '#tool_reference,#tool_reference_multi', fn: clickReference, evt: 'click', key: ['R', true]},
