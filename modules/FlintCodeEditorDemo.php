...
$output .= "<script src='res/d3.js' type='text/javascript' charset='utf-8'></script>";
...
$output .= "<div id='editorButtons'><button id='edit_cancel' class='editorButton' onclick='drawNode()'>Cancel</button>";
$output .= "<button id='edit_save' class='editorButton' onclick='drawModel()'>Save changes</button></div>";
$output .= "<div id='canvas'></div>";
